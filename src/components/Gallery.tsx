    ...
    <section id="gallery" className="bg-[var(--color-paper)] py-20 md:py-28">
      <div className="section-shell">
        ...
        {gallery.items.length === 0 ? (
          <div className="border border-dashed border-[var(--color-line)] bg-[var(--color-paper-tint)] p-12 text-center text-[var(--color-slate)]">
            <div className="mx-auto mb-4 grid h-14 w-14 place-items-center bg-[var(--color-blue)] text-2xl text-white" aria-hidden>＋</div>
